...
//		mynums1.addAt(4,100); mynums1.printLinkedList();
//		mynums1.addAt(0,100); mynums1.printLinkedList();

//		// testing toArray()
//		printArray(mynums1.toArray());
		
		// testing clone()
//		MyLinkedList<Integer> myclone = mynums1.clone();
//		myclone.printLinkedList();
//		System.out.println(mynums1 == myclone);
